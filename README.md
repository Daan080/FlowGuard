...
| -------- | --- | --- | --- | --- | --- | --- |
|**Welke emotie roept deze kleur op?** | - rust <br> - toegankelijk<br> - bereikbaar | - ruime inbreng, van oppassen voor stress tot feest | - tussen groen en rood <br> - vooral een gevoel van stress en opletten <br> - eerder aan de kant van rood | - opgelet!<br>- stress!<br> - gevaar!<br> - focus! | - rust<br> - kalmte<br> - pauze | - neutraal<br> - sfeerlamp |
